...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void initTitlesAndIndicator() {
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    if (mTitleMargin > 0) {
                        lp.setMarginStart(mTitleMargin);
                    }
                }
        ...
        if (mAdapter != null) {
            ...
            if (mIndicator instanceof View) {
                LayoutParams lp = (FrameLayout.LayoutParams) ((View) mIndicator).getLayoutParams();
                if (lp == null) {
    ...
    public void setTitleMargin(int mTitleMargin) {
        this.mTitleMargin = mTitleMargin;
    }
}
