...
public class CusCircleDrawable extends Drawable {
    ...
    public static final String TAG = "CusCircleDrawable";
    ...
    public CusCircleDrawable(Bitmap bitmap) {
        mBitmap = bitmap;
    ...
    public static CusCircleDrawable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            return new CusCircleDrawable(bitmap);
        } else {
            return null;
        }
    }
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof CusCircleDrawable) {
                // just return if it's already a CusCircleDrawable
                return drawable;
            ...
            if (bm != null) {
                return new CusCircleDrawable(bm);
            }
        }
        return drawable;
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        if (mRebuildShader) {
            ...
            if (mTileModeX == Shader.TileMode.CLAMP && mTileModeY == Shader.TileMode.CLAMP) {
                bitmapShader.setLocalMatrix(mShaderMatrix); // 设置坐标变换矩阵
            }
            mBitmapPaint.setShader(bitmapShader);// 画笔设置着色器
            mRebuildShader = false;
        }

        if (mOval) {
            if (mBorderWidth > 0) {  // 带有边界
     ...
     * @return the {@link CusCircleDrawable} for chaining.
     */
    public CusCircleDrawable setCornerRadius(float radius) {
     ...
     * @return the {@link CusCircleDrawable} for chaining.
     */
    public CusCircleDrawable setCornerRadius(@Corner int corner, float radius) {
     ...
     * @return the {@link CusCircleDrawable} for chaining.
     */
    public CusCircleDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                             float bottomLeft) {
    ...
    public CusCircleDrawable setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public CusCircleDrawable setBorderColor(@ColorInt int color) {
        return setBorderColor(ColorStateList.valueOf(color));
    }

    public CusCircleDrawable setBorderColor(ColorStateList colors) {
    ...
    public CusCircleDrawable setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public CusCircleDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public CusCircleDrawable setTileModeX(Shader.TileMode tileModeX) {
    ...
    public CusCircleDrawable setTileModeY(Shader.TileMode tileModeY) {
