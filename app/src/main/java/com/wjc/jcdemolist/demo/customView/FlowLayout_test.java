...
public class FlowLayout_test extends ViewGroup {
    ...
    public FlowLayout_test(Context context) {
        this(context, null);
    }

    public FlowLayout_test(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayout_test(Context context, AttributeSet attrs, int defStyle) {
